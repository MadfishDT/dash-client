<template>
        <div class="row justify-content-center">
            <div class="col-lg-11 col-md-7 bg-white">
                <div class="card bg-white  border-0">
                    <div class="card-body px-lg-11 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-black">Agreement</h1>
                         </div>
                    </div>
                        <textarea cols="90" rows="50" readonly>
GOOGLE 서비스 약관
...
Google은 저작권자가 온라인상에서 자신의 지적 재산을 관리할 수 있도록 정보를 제공합니다. 누군가 귀하 의 저작권을 침해하고 있다고 생각되어 Google에 통지하고자 하는 경우, Google 도움말 센터에서 신고서 제출 방법 및 저작권 침해 신고에 대한 Google 대응 정책 관련 정보를 확인하실 수 있습니다.
                          ...
                          <div>
                    <base-radio  key="agree" name="Agree"
                    class="mb-3"  v-model="agree" style="padding-left: 13rem" position="right">Agree.</base-radio>
                    <div class="text-center">
                    <base-button type="dark" v-on:click="goon" class="my-4">Continue</base-button>
                    <base-button type="dark" v-on:click="cancel" class="my-4">Cancel</base-button>
                    </div>
                    </div>
                    </div>
                </div>
        ...
        methods: {
            goon: async function() {
                    ...
                    if(this.agree === 'Agree') {
                        ...
                        await this.$swal('Please check agreement');
                    }
